...
let s_define_pred fmt fun_symbol args defn = 
...
let export_system dirname file names sys name_sys =
...
let export_phi dirname file names phi =
...
let export_obs_system
  ...
  s_define_pred fmt names_obs.init ["i"]
  ...
  s_define_pred fmt names_obs.trans ["i"; "j"]
  ...
  s_define_pred fmt names_obs.prop ["i"]
...
let generate_slice_obs node kind2_sys param dirname =
  ...
  *)
  ...
  export_system dirname unsliced_defs_f names_unsliced unsliced_sys "unsliced";
  ...
  export_obs_system dirname obs_defs_f
    names_obs names_sliced names_unsliced same_inputs_term;
...
let generate_frontend_certificates sys dirname =
  ...
  (* Export k-inductive invariant phi in SMT-LIB2 format *)
  export_phi dirname obs_phi_f names_obs phi;
